...
namespace WoWonder.Activities.Fundings
{
    ...
    public class FundingViewActivity : BaseActivity, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback, IPaymentResultWithDataListener, IBillingPaymentListener 
    {

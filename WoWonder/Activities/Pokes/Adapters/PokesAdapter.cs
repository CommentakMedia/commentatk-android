                    ...
                    case PokesAdapterViewHolder holder:
                    {
                        ...
                        if (item != null)
                        {
                                if (item.UserData?.UserDataClass != null)
                                {
                                    ...
                                    holder.ImageLastSeen.SetColorFilter(Color.ParseColor("#FFAE35"));
                                    holder.IconImage.Visibility = ViewStates.Visible;
                                    holder.IconImage.SetImageResource(Resource.Drawable.ic_small_poke);
                                }
    ...
    public class PokesAdapterViewHolder : RecyclerView.ViewHolder
    {
        ...
        public PokesAdapterViewHolder(View itemView, Action<PokesAdapterClickEventArgs> clickListener, Action<PokesAdapterClickEventArgs> longClickListener) : base(itemView)
        {
            try
            {
                ...
                IconImage = MainView.FindViewById<ImageView>(Resource.Id.smallIcon);
        ...
        public void BindEvents(int position, PokeObject.Datum data, AppCompatButton button, IOnPokeItemClickListener pokeItemClickListener)
        {
        ...
        public class PokeClickEvents : Java.Lang.Object, View.IOnClickListener
        {
            ...
            public AppCompatButton PokeButton;
            public IOnPokeItemClickListener PokeItemClickListener;
            public void SetClickEvents(int position, PokeObject.Datum data, AppCompatButton button, IOnPokeItemClickListener pokeItemClickListener)
            {
                PokeButton = button;
                UserData = data;
                Position = position;

...
namespace WoWonder.Activities.Upgrade
{
    ...
    public class GoProActivity : BaseActivity, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback , IPaymentResultWithDataListener, IBillingPaymentListener
    {

...
namespace WoWonder.Activities.Story.Adapters
{
    public class StoryShowAdapter : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider, RecyclerView.IOnChildAttachStateChangeListener
    {
        ...
        public static SimpleExoPlayer VideoPlayer { get; set; }
                ...
                if (viewHolder is StoryShowAdapterViewHolder holder)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        else if (type == "Video")
                        {
                            ...
                            if (PlayerView == null || VideoPlayer == null)
                            ...
                            if (mediaFile.Contains("http"))
                            {
                                ...
                                VideoPlayer.AddListener(holder);
    ...
    public class StoryShowAdapterViewHolder : RecyclerView.ViewHolder, View.IOnClickListener, View.IOnLongClickListener, IPlayerEventListener
    {
        ...
        public void InitVideoView(View view)
        {
            ...
            { 
                ...
                StoryShowAdapter.VideoPlayer = new SimpleExoPlayer.Builder(MAdapter.ActivityContext).SetTrackSelector(trackSelector).Build();

                StoryShowAdapter.PlayerView.UseController = false;
                StoryShowAdapter.PlayerView.Player = StoryShowAdapter.VideoPlayer;
                StoryShowAdapter.PlayerView.RequestFocus();
        ...
        public void PlayPlayer()
        {
            try
            {
                if (StoryShowAdapter.PlayerView?.Player != null && StoryShowAdapter.PlayerView.Player.PlaybackState == IPlayer.StateReady && PlayerPaused)
                    StoryShowAdapter.PlayerView.Player.PlayWhenReady = true;
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
        ...
        public void PausePlayer()
        {
            try
            {
                if (StoryShowAdapter.PlayerView?.Player != null && StoryShowAdapter.PlayerView.Player.PlaybackState == IPlayer.StateReady)
                {
                    PlayerPaused = true;
        ...
        public void Destroy()
        {
            try
            {
                ...
                StoryShowAdapter.VideoPlayer?.Release();
                StoryShowAdapter.VideoPlayer = null;
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);

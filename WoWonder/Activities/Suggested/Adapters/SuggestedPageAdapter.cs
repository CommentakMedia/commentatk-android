                            ...
                            if (item != null)
                            {
                                ...
                                else
                                {
                                    ...
                                    { 
                                        ...
                                        holder.LikeButton.SetBackgroundResource(Resource.Drawable.liked_button_normal);
                                    ...
                                    else
                                    {
                                        ...
                                        holder.LikeButton.SetBackgroundResource(Resource.Drawable.liked_button_pressed);

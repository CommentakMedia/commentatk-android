    ...
    public class AdapterBind
    {
        ...
        public void MyProfileInfoHeaderSectionBind(AdapterHolders.MyProfileInfoHeaderSectionHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                { 
                    if (item.InfoUserModel.UserData.Avatar.Contains("d-avatar") || item.InfoUserModel.UserData.Avatar.Contains("f-avatar"))
                    {
                        if (item.InfoUserModel.UserData.Gender.ToLower() == "female")
                            GlideImageLoader.LoadImage(ActivityContext, "no_profile_female_image_circle", holder.ImageAvatar, ImageStyle.CircleCrop, ImagePlaceholders.DrawableUser);
                        else
                            GlideImageLoader.LoadImage(ActivityContext, "no_profile_image_circle", holder.ImageAvatar, ImageStyle.CircleCrop, ImagePlaceholders.DrawableUser);
                    }
                    else
                    {
                        GlideImageLoader.LoadImage(ActivityContext, item.InfoUserModel.UserData.Avatar, holder.ImageAvatar, ImageStyle.CircleCrop, ImagePlaceholders.DrawableUser);
                    } 

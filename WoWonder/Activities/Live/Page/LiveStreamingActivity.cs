            ...
            try
            {
                ...
                switch (IsOwner)
                {
                    case true:
                    {
                        if (PostObject != null)
                        {
                            GlideImageLoader.LoadImage(this, PostObject.Publisher.Avatar, BgAvatar, ImageStyle.CenterCrop, ImagePlaceholders.DrawableUser);
                            GlideImageLoader.LoadImage(this, PostObject.Publisher.Avatar, StreamRateLevel, ImageStyle.CircleCrop, ImagePlaceholders.DrawableUser);
                        }
                    ...
                    default:
                    {
                        ...
                        {
                            GlideImageLoader.LoadImage(this, LiveStreamViewerObject.Publisher.Avatar, BgAvatar, ImageStyle.CenterCrop, ImagePlaceholders.DrawableUser);
                            GlideImageLoader.LoadImage(this, LiveStreamViewerObject.Publisher.Avatar, StreamRateLevel, ImageStyle.CircleCrop, ImagePlaceholders.DrawableUser);
                        }

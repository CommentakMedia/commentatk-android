    ...
    public static class GlideImageLoader
    {
        public static void LoadImage(Activity activity, string imageUri, ImageView image, ImageStyle style, ImagePlaceholders imagePlaceholders, bool compress = false, RequestOptions options = null)
        {
            try
            {
                ...
                if (imageUri.Contains("no_profile_image") || imageUri.Contains("no_profile_female_image") || imageUri.Contains("blackdefault") 
                    || imageUri.Contains("no_profile_image_circle")|| imageUri.Contains("no_profile_female_image_circle")
        ...
        public static RequestOptions GetOptions(ImageStyle style, ImagePlaceholders imagePlaceholders)
        {
            try
            {
                ...
                {
                    if (style is ImageStyle.CircleCrop or ImageStyle.CircleCropWithBorder) options.Placeholder(Resource.Drawable.ImagePlacholder_circle).Fallback(Resource.Drawable.ImagePlacholder_circle);
                    else
                ...
                {
                    if (style is ImageStyle.CircleCrop or ImageStyle.CircleCropWithBorder) options.Placeholder(Resource.Drawable.no_profile_image_circle).Fallback(Resource.Drawable.no_profile_image_circle);
                    else
